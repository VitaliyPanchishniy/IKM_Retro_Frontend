  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <motion.div
        ...
        className="w-full max-w-5xl bg-white rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row"
      >
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="md:w-1/2 bg-purple-200 p-8 flex flex-col justify-center"
        >
          <div className="mb-8">
          ...
          >
            Create, share and iterate with your team in real-time
          </motion.p>
        </motion.div>
        ...
        >
          <div className="mb-6">
            <div className="grid grid-cols-2 gap-0 mb-6 bg-gray-100 p-1 rounded-lg">
              <Link href="/login" className="py-2 text-center font-medium text-gray-600 hover:text-gray-800">
                Sign In
              </Link>
              <Link href="/signup" className="py-2 text-center font-medium bg-white rounded-md shadow-sm">
                Sign Up
              </Link>
            </div>
            <motion.h2
            ...
            <motion.p
              ...
              className="text-gray-600"
            >
              Sign up to get started with RetroKM
            </motion.p>
          </div>
